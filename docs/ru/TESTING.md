...
- Поток из миллиона File без списка консьюмера, предел очереди 10000, повтор удерживаемого потока.
- Виртуальные десять часов и 1000 повторов, включая неудачные проверки квитанций.
- Ранний маппинг без тела, вопрос до завершения манифеста и отмена во время callback.
- Обход 100000 записей SQLite и страницы результатов по 256 путей.
